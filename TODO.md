...
- [ ] Meta description sur chaque page dans `<head>` :
  `<meta name="description" content=".....description du site....">`
- [ ] Présence de balises sémantiques HTML5 bien organisées
  (`<header>`, `<nav>`, `<main>`, `<footer>`, etc....)
- [ ] Utilisation appropriée des balises de titre (`<h1>`, `<h2>`, `<h3>`, etc...) pour structurer le contenu
- [ ] images
